...
import { ApiPutHelper, logout } from "helper";
...
const ProfileEditor = () => {
  ...
  const handleFormSubmit = async (values: any, action: any) => {
    ...
    if (userData) {
      ...
      const response = await ApiPutHelper(`${API}/auth/users/update-user`, values);
    ...
    <div>
      ...
      <Card1>
        <FlexBox alignItems="flex-end" mb="22px">
          <Avatar src="/assets/images/faces/avatar.png" size={64} />
