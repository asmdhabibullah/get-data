...
import BookCard from '@component/products/BookCard';
...
export interface BooksCardProps extends CardProps {
  className?: string;
  style?: CSSProperties;
  imgUri?: string;
  title?: string;
...
const ProductCard1: React.FC<BooksCardProps> = ({
  id,
  imgUri,
  title,
  price,
    ...
    <StyledProductCard1 {...props}>
      ...
      <Modal open={open} onClose={toggleDialog}>
        <Card p="1rem" position="relative">
          <BookCard imgUri={imgUri} title={title} price={price} id={id} />
          <Box
            position="absolute"
            top="0.75rem"
            right="0.75rem"
...
//   imgUri: '/assets/images/products/macbook.png',
//   off: 50,
//   price: 450,
//   rating: 0,
// };
