...
import authNavbarNavigations from "@data/authNavbarNavigations";
  ...
  return (
    <StyledNavbar>
      ...
      >
        ...
        <FlexBox>{
          isAuthenticated ? renderNestedNav(authNavbarNavigations, true) : renderNestedNav(navbarNavigations, true)
        }</FlexBox>
      </Container>
    </StyledNavbar>
  );
