    ...
    <Container mb="80px">
      <FlexBox>
        ...
        <Box flex="1 1 0" minWidth="0px">
          <CategorySectionHeader title="Top Authors Books" seeMoreLink="#" />
...
const brandList = ["Matthew Scarpino", "Andrew Schmidt", "Daniel Minoli", "Daniel Selman", "Magnus Rydin", "Gal Shachor"];
